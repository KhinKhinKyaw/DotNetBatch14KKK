...
{
    public class BlogService4 : IBlogService4
    {
        ...
        public List<BlogModel4> GetBlogs()
        {
            ...
            List<BlogModel4> lst = new List<BlogModel4>();
            foreach (DataRow row in dt.Rows)
            {
                BlogModel4 item = new BlogModel4();
        ...
        public BlogResponse1 Update(BlogModel4 Model)
        {
        ...
        public BlogResponse1 UpInsert(BlogModel4 model)
        {
